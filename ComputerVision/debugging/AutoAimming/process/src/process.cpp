...
cv::Mat preprocess (cv::Mat img_in)
{
	...
	cv::medianBlur (img_in,imgblur, 3);
	cv::bilateralFilter (imgblur, imgbila, 0, 32, 23);
	cv::pyrMeanShiftFiltering (imgblur, imgshift, 25, 12);
...
// {
//     cv::Mat sx, sy;
// 	cv::Mat imgBlur, imgGaussin, imgMedian, imgBilateral, imgtest, imgtest2, imgtest3;
//  
...
// 	cv::blur (img_in, imgBlur, cv::Size (9, 9));
// 	cv::GaussianBlur (img_in, imgGaussin, cv::Size (3, 3), 0, 3);
// 	cv::medianBlur (img_in, imgMedian, 9);
// 	cv::bilateralFilter (img_in, imgBilateral, 3, 100, 20);
// 	cv::pyrMeanShiftFiltering (imgMedian, imgtest, 25, 25);
// 	cv::pyrMeanShiftFiltering (imgBilateral, imgtest2, 25, 25);
// 	cv::pyrMeanShiftFiltering (imgBlur, imgtest3, 25, 25);
//     cv::pyrMeanShiftFiltering (img_in, img_out, 25, 25);
// 	
//     // cv::dilate (img_out, img_out, kernel);
//     cv::imshow ("SHIFT", img_out);
// 	cv::imshow ("Blur", imgBlur);
// 	cv::imshow ("GaussianBlur", imgGaussin);
// 	cv::imshow ("medianBlur", imgMedian);
// 	cv::imshow ("bilateralFilter", imgBilateral);
// 	cv::imshow ("Test", imgtest);
// 	cv::imshow ("Test2", imgtest2);
// 	cv::imshow ("Test3", imgtest3);
// 	cv::imwrite ("../imgs/testimg.jpg", imgtest3);;
...
std::vector <cv::Mat> getStandard (cv::Mat img_pre, cv::Mat img)
{
    ...
    cv::findContours (img_pre, contours, cv::RETR_LIST, cv::CHAIN_APPROX_SIMPLE);
